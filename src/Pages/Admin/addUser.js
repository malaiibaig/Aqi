...
function AddUser ( props )
{
	...
	const AddUsers = () =>
	{
		...
		fetch( api_url + "admin/create_user", requestOptions )
					...
					>
						...
						<div className="flex items-center justify-between mt-2">
							...
							<div class="flex items-center mb-4">
								...
								<label for="data-checkbox" class="ms-2 sm:text-[1.2rem] lm:text-[1.6rem] tab:text-[1.8rem] sl:text-[1.8vw] lt:text-[1.2vw]">Data Download</label>
							</div>
							<div class="flex items-center mb-4">
								...
								<label for="report-checkbox" class="ms-2 sm:text-[1.2rem] lm:text-[1.6rem] tab:text-[1.8rem] sl:text-[1.8vw] lt:text-[1.2vw]">Reports Download</label>
							</div>
						</div>
						
						{ error && (
							<h6 className="lt:text-[1vw] sm:text-sm text-[red]">
								{errorMessage}
							</h6>
						) }
						<br />
